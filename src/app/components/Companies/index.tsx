...
export const Companies = () => {
  return (
    <div className="w-full h-[340px] flex flex-col items-center justify-center gap-20 ">
      <div className="w-full max-w-[1980px] h-full flex flex-col items-center justify-center">
        ...
        <h2 className="text-2xl md:text-4xl text-white font-bold text-center">
          Empresas unidas contra as <br /> <span className="text-primaryDefault">fake news</span>
        </h2>
